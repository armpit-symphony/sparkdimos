...
from lima.agents.system_prompt import SYSTEM_PROMPT
from lima.agents.utils import pretty_print_langchain_message
from lima.core.core import rpc
from lima.core.module import Module, ModuleConfig, SkillInfo
from lima.core.rpc_client import RpcCall, RPCClient
from lima.core.stream import In, Out
from lima.protocol.rpc import RPCSpec
...
class Agent(Module[AgentConfig]):
    ...
    def on_system_modules(self, modules: list[RPCClient]) -> None:
        ...
        if self.config.model.startswith("ollama:"):
            from lima.agents.ollama_agent import ensure_ollama_model
        ...
        if self.config.model_fixture is not None:
            from lima.agents.testing import MockModel
