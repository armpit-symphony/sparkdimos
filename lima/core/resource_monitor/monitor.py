...
from lima.core.resource_monitor.stats import (
    WorkerStats,
...
if TYPE_CHECKING:
    ...
    from lima.core.resource_monitor.logger import ResourceLogger
...
class StatsMonitor(Resource):
    ...
    def __init__(
        ...
        if resource_logger is not None:
            ...
            from lima.core.resource_monitor.logger import LCMResourceLogger
