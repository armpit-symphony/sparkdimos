...
if TYPE_CHECKING:
    from lima.protocol.service.system_configurator.base import SystemConfigurator

from lima.core.global_config import GlobalConfig, global_config
from lima.core.module import Module, is_module_type
from lima.core.module_coordinator import ModuleCoordinator
from lima.core.stream import In, Out
from lima.core.transport import LCMTransport, PubSubTransport, pLCMTransport
from lima.spec.utils import Spec, is_spec, spec_annotation_compliance, spec_structural_compliance
from lima.utils.generic import short_id
...
class Blueprint:
    ...
    def _run_configurators(self) -> None:
        from lima.protocol.service.system_configurator import configure_system, lcm_configurators
