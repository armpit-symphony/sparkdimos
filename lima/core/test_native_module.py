...
from lima.core.native_module import LogFormat, NativeModule, NativeModuleConfig
...
@pytest.mark.slow
def test_manual(lima_cluster: ModuleCoordinator, args_file: str) -> None:
    native_module = lima_cluster.deploy(  # type: ignore[attr-defined]
        StubNativeModule,
        some_param=2.5,
