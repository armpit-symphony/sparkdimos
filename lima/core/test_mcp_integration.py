...
from lima.core.global_config import global_config
from lima.core.run_registry import (
    RunEntry,
    cleanup_stale,
    list_runs,
)
from lima.core.tests.stress_test_module import StressTestModule
from lima.robot.cli.dimos import main
...
def _clean_registry(
    ...
    import lima.core.run_registry as _reg
...
class TestMCPCLICommands:
    """Test lima mcp CLI commands against real MCP server."""

    def test_cli_list_tools(self, mcp_shared: ModuleCoordinator) -> None:
        """lima mcp list-tools should output JSON with tools."""
    ...
    def test_cli_call_echo(self, mcp_shared: ModuleCoordinator) -> None:
        """lima mcp call echo --arg message=hello should return hello."""
    ...
    def test_cli_mcp_status(self, mcp_shared: ModuleCoordinator) -> None:
        """lima mcp status should return JSON with modules."""
    ...
    def test_cli_mcp_modules(self, mcp_shared: ModuleCoordinator) -> None:
        """lima mcp modules should show module-skill mapping."""
...
class TestMCPErrorHandling:
    ...
    def test_cli_call_tool_wrong_arg_format(self, mcp_shared: ModuleCoordinator) -> None:
        """lima mcp call with bad --arg format should error."""
    ...
    def test_cli_call_json_args(self, mcp_shared: ModuleCoordinator) -> None:
        """lima mcp call --json-args should work."""
    ...
    def test_cli_call_bad_json_args(self, mcp_shared: ModuleCoordinator) -> None:
        """lima mcp call with invalid --json-args should error."""
...
@pytest.mark.slow
class TestAgentSend:
    """Test lima agent-send CLI and MCP method."""
    ...
    def test_agent_send_cli(self, mcp_shared: ModuleCoordinator) -> None:
        """lima agent-send 'hello' should work."""
