...
if TYPE_CHECKING:
    ...
    from lima.core.introspection.blueprint.dot import LayoutAlgo
    from lima.core.introspection.module.info import ModuleInfo
...
def to_svg(
    ...
    *,
    ...
    if isinstance(target, ModuleInfo):
        from lima.core.introspection.module import dot as module_dot

        module_dot.render_svg(target, output_path)
    elif isinstance(target, Blueprint):
        from lima.core.introspection.blueprint import dot as blueprint_dot
