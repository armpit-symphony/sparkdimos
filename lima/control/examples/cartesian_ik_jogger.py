...
Usage:
    python -m lima.control.examples.cartesian_ik_jogger
"""
...
def main() -> None:
    ...
    Note: This only runs the UI. The coordinator must be started separately:
        Terminal 1: lima run coordinator-cartesian-ik-mock
        Terminal 2: python -m lima.control.examples.cartesian_ik_jogger
    """
    run_jogger_ui()
