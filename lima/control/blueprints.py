...
Usage:
    # Run via CLI:
    lima run coordinator-mock           # Mock 7-DOF arm
    lima run coordinator-xarm7          # XArm7 real hardware
    lima run coordinator-dual-mock      # Dual mock arms
...
from lima.msgs.geometry_msgs import PoseStamped, Twist
