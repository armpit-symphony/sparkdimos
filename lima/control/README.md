...
LIMA run coordinator-mock          # Single 7-DOF mock arm
LIMA run coordinator-dual-mock     # Dual arms (7+6 DOF)
LIMA run coordinator-piper-xarm    # Real hardware
...
```python
from LIMA.control import control_coordinator, HardwareComponent, TaskConfig
...
```python
from LIMA.control.task import ControlTask, ResourceClaim, JointCommandOutput, ControlMode
