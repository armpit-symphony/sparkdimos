...
from lima.hardware.manipulators.spec import ControlMode, ManipulatorAdapter

if TYPE_CHECKING:
    from lima.control.components import HardwareComponent, HardwareId, JointName, JointState
    from lima.hardware.drive_trains.spec import TwistBaseAdapter
...
class ConnectedHardware:
    ...
    def read_state(self) -> dict[JointName, JointState]:
        ...
        """
        from lima.control.components import JointState
...
class ConnectedTwistBase(ConnectedHardware):
    ...
    def __init__(
        ...
        from lima.hardware.drive_trains.spec import TwistBaseAdapter as TwistBaseAdapterProto
