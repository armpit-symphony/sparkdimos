...
from lima.control.components import (
    TWIST_SUFFIX_MAP,
    HardwareComponent,
    HardwareId,
    HardwareType,
...
from lima.control.hardware_interface import ConnectedHardware, ConnectedTwistBase
from lima.control.task import ControlTask
from lima.control.tick_loop import TickLoop
from lima.core.core import rpc
from lima.core.module import Module, ModuleConfig
from lima.core.stream import In, Out
from lima.hardware.drive_trains.spec import (
    TwistBaseAdapter,
)
from lima.hardware.manipulators.spec import ManipulatorAdapter
from lima.msgs.geometry_msgs import (
    PoseStamped,
    Twist,
)
from lima.msgs.sensor_msgs import (
    JointState,
)
from lima.teleop.quest.quest_types import (
    Buttons,
)
...
class ControlCoordinator(Module[ControlCoordinatorConfig]):
    ...
    Example:
        >>> from lima.control import ControlCoordinator
        >>> from lima.hardware.manipulators.xarm import XArmAdapter
        >>>
    ...
    def _create_twist_base_adapter(self, component: HardwareComponent) -> TwistBaseAdapter:
        ...
        from lima.hardware.drive_trains.registry import twist_base_adapter_registry
    ...
    def _create_task_from_config(self, cfg: TaskConfig) -> ControlTask:
        ...
        if task_type == "trajectory":
            from lima.control.tasks import JointTrajectoryTask, JointTrajectoryTaskConfig
            ...
            from lima.control.tasks import JointServoTask, JointServoTaskConfig
            ...
            from lima.control.tasks import JointVelocityTask, JointVelocityTaskConfig
            ...
            from lima.control.tasks import CartesianIKTask, CartesianIKTaskConfig
            ...
            from lima.control.tasks.teleop_task import TeleopIKTask, TeleopIKTaskConfig
