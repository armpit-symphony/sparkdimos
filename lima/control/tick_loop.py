...
Separated from coordinator.py following the LIMA pattern of
...
if TYPE_CHECKING:
    ...
    from lima.control.components import HardwareId, JointName, TaskName
    from lima.control.hardware_interface import ConnectedHardware
    from lima.hardware.manipulators.spec import ControlMode
