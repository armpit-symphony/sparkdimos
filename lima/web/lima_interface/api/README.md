...
## Integration with LIMA Agents

See LIMA Documentation for more info.

```python
from LIMA.agents_deprecated.agent import OpenAIAgent
from LIMA.robot.unitree.unitree_go2 import UnitreeGo2
from LIMA.robot.unitree.unitree_skills import MyUnitreeSkills
