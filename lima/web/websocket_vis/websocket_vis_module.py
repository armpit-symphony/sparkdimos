...
"""
WebSocket Visualization Module for LIMA Robotics navigation and mapping.
...
from lima_lcm.std_msgs import Bool  # type: ignore[import-untyped]
...
from lima.mapping.occupancy.gradient import gradient
from lima.mapping.occupancy.inflation import simple_inflate
from lima.mapping.types import LatLon
from lima.msgs.geometry_msgs import PoseStamped, Twist, TwistStamped, Vector3
from lima.msgs.nav_msgs import OccupancyGrid, Path
...
class WebsocketVisModule(Module):
    ...
    def start(self) -> None:
        ...
        if self._global_config.viewer == "rerun-web":
            ...
            logger.info(f"LIMA Command Center: {url}")
    ...
    def _create_server(self) -> None:
        ...
        async def serve_command_center(request):  # type: ignore[no-untyped-def]
            ...
            if index_file.exists():
                ...
                return Response(
                    content="Command center not built. Run: cd lima/web/command-center-extension && npm install && npm run build:standalone",
                    status_code=503,
