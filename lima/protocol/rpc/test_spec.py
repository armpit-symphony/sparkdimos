...
from lima.protocol.rpc.pubsubrpc import LCMRPC, ShmRPC
from lima.protocol.rpc.rpc_utils import RemoteError
...
try:
    from lima.protocol.rpc.redisrpc import RedisRPC
