...
from lima.constants import LCM_MAX_CHANNEL_NAME_LENGTH
from lima.protocol.pubsub.impl.lcmpubsub import PickleLCM, Topic
from lima.protocol.pubsub.impl.shmpubsub import PickleSharedMemory
from lima.protocol.pubsub.spec import PubSub
from lima.protocol.rpc.rpc_utils import deserialize_exception, serialize_exception
from lima.protocol.rpc.spec import Args, RPCSpec
            ...
            if topic_res_key not in self._response_subs:
                ...
                def shared_response_handler(msg: MsgT, _: TopicT) -> None:
                    ...
                    if exc_data:
                        ...
                        from lima.protocol.rpc.rpc_utils import SerializedException
