...
from lima.msgs.tf2_msgs import TFMessage
from lima.protocol.pubsub.impl.lcmpubsub import LCM, Topic
from lima.protocol.pubsub.spec import PubSub
from lima.protocol.service.lcmservice import Service  # type: ignore[attr-defined]
...
class TBuffer(InMemoryStore[Transform]):
    ...
    def __str__(self) -> str:
        ...
        if time_range and first_item:
            from lima.types.timestamped import to_human_readable
