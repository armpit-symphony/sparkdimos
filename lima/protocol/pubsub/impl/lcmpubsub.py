...
from lima.protocol.pubsub.encoders import (
    JpegEncoderMixin,
    LCMEncoderMixin,
    PickleEncoderMixin,
)
from lima.protocol.pubsub.patterns import Glob
from lima.protocol.pubsub.spec import AllPubSub
from lima.protocol.service.lcmservice import LCMConfig, LCMService, autoconf
...
class Topic:
    ...
    lcm_type: type[LimaMsg] | None = None
    ...
    @staticmethod
    def from_channel_str(channel: str, default_lcm_type: type[LimaMsg] | None = None) -> Topic:
        ...
        """
        from lima.msgs import resolve_msg_type
