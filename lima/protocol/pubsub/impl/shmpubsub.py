...
from lima.protocol.pubsub.encoders import LCMEncoderMixin, PickleEncoderMixin
from lima.protocol.pubsub.impl.lcmpubsub import Topic
from lima.protocol.pubsub.shm.ipc_factory import CpuShmChannel
...
class SharedMemoryConfig:
    prefer: str = "auto"  # "auto" | "cpu"  (LIMA_IPC_BACKEND overrides), TODO: "cuda"
...
class SharedMemoryPubSubBase(PubSub[str, Any]):
    ...
    def start(self) -> None:
        ...
        backend = os.getenv("LIMA_IPC_BACKEND", pref).lower()
