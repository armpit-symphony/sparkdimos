...
"""Base agent module that wraps BaseAgent for LIMA module usage."""

import threading
from typing import Any

from lima.agents_deprecated.agent_message import AgentMessage
from lima.agents_deprecated.agent_types import AgentResponse
...
try:
    ...
    from lima.agents_deprecated.modules.base import BaseAgent

logger = setup_logger()


class BaseAgentModule(BaseAgent, Module):  # type: ignore[misc]
    """Agent module that inherits from BaseAgent and adds LIMA module interface.

    This provides a thin wrapper around BaseAgent functionality, exposing it
    through the LIMA module system with RPC methods and stream I/O.
    """
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        **kwargs,
        ...
        """
        # Initialize Module first (important for LIMA)
