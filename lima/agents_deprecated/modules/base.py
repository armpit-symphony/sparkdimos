...
from lima.agents_deprecated.agent_types import AgentResponse, ConversationHistory, ToolCall
...
try:
    ...
    from lima.agents_deprecated.modules.gateway import UnifiedGatewayClient
