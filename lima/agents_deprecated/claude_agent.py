...
"""Claude agent implementation for the LIMA agent framework.

This module provides a ClaudeAgent class that implements the LLMAgent interface
for Anthropic's Claude models. It handles conversion between the LIMA skill format
...
# Local imports
from lima.agents_deprecated.agent import LLMAgent
...
class ClaudeAgent(LLMAgent):
    ...
    def _convert_tools_to_claude_format(self, tools: list[dict[str, Any]]) -> list[dict[str, Any]]:
        """
        Converts LIMA tools to Claude format.

        Args:
            tools: List of tools in LIMA format.
