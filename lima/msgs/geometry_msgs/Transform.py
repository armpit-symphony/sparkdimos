...
from lima_lcm.geometry_msgs import (
...
from lima.types.timestamped import Timestamped
...
class Transform(Timestamped):
    ...
    def from_pose(cls, frame_id: str, pose: Pose | PoseStamped) -> Transform:  # type: ignore[name-defined]
        ...
        from lima.msgs.geometry_msgs.Pose import Pose
        from lima.msgs.geometry_msgs.PoseStamped import PoseStamped
    ...
    def to_pose(self, **kwargs: object) -> PoseStamped:
        ...
        """
        # Import locally to avoid circular imports
        from lima.msgs.geometry_msgs.PoseStamped import PoseStamped as _PoseStamped
    ...
    def lcm_decode(cls, data: bytes | BinaryIO) -> Transform:
        ...
        from lima_lcm.tf2_msgs import TFMessage as LCMTFMessage
