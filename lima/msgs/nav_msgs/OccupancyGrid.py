...
from lima_lcm.nav_msgs import (
    MapMetaData,
    OccupancyGrid as LCMOccupancyGrid,
)
from lima_lcm.std_msgs import Time as LCMTime  # type: ignore[import-untyped]
import matplotlib.pyplot as plt
import numpy as np
from PIL import Image

from lima.msgs.geometry_msgs import Pose, Vector3, VectorLike
