...
from lima.manipulation.planning import (
    JointPath,
...
from lima.manipulation.planning.monitor import WorldMonitor
...
class ManipulationModule(Module):
    ...
    def preview_path(self, duration: float = 3.0, robot_name: RobotName | None = None) -> bool:
        ...
        """
        from lima.manipulation.planning.utils.path_utils import interpolate_path
