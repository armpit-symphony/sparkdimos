...
def create_kinematics(
    ...
    **kwargs: Any,
    ...
    if name == "jacobian":
        from lima.manipulation.planning.kinematics.jacobian_ik import JacobianIK

        return JacobianIK(**kwargs)
    elif name == "drake_optimization":
        from lima.manipulation.planning.kinematics.drake_optimization_ik import (
            DrakeOptimizationIK,
        )
...
def create_planner(
    ...
    **kwargs: Any,
    ...
    if name == "rrt_connect":
        from lima.manipulation.planning.planners.rrt_planner import RRTConnectPlanner
