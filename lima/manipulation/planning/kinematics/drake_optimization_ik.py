...
from lima.manipulation.planning.spec import IKResult, IKStatus, WorldRobotID, WorldSpec
from lima.manipulation.planning.utils.kinematics_utils import compute_pose_error
from lima.msgs.geometry_msgs import PoseStamped, Transform
from lima.msgs.sensor_msgs import JointState
from lima.utils.logging_config import setup_logger
from lima.utils.transform_utils import pose_to_matrix
...
class DrakeOptimizationIK:
    ...
    def _validate_world(self, world: WorldSpec) -> IKResult | None:
        from lima.manipulation.planning.world.drake_world import DrakeWorld
