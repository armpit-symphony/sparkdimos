...
LIMA run xarm7-planner-coordinator                                    # terminal 1
python -i -m LIMA.manipulation.planning.examples.manipulation_client  # terminal 2
```
...
from LIMA.manipulation import ManipulationModule
...
pytest LIMA/manipulation/test_manipulation_unit.py -v

# Integration tests (requires Drake)
pytest LIMA/e2e_tests/test_manipulation_module.py -v
```
