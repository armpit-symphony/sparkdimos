...
from lima.manipulation.planning.factory import create_world
from lima.manipulation.planning.monitor.world_obstacle_monitor import WorldObstacleMonitor
from lima.manipulation.planning.monitor.world_state_monitor import WorldStateMonitor
from lima.msgs.geometry_msgs import PoseStamped
...
if TYPE_CHECKING:
    ...
    from lima.manipulation.planning.spec import (
    ...
    from lima.msgs.vision_msgs import Detection3D
    from lima.perception.detection.type.detection3d.object import Object
...
class WorldMonitor:
    ...
    def on_detections(self, detections: list[Detection3D]) -> None:
        """Handle perception detections (Detection3D from lima.msgs.vision_msgs)."""
        if self._obstacle_monitor is not None:
    ...
    def get_link_pose(
        ...
        """
        from lima.msgs.geometry_msgs import Quaternion
