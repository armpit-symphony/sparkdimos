...
```python
from LIMA.hardware.manipulators.xarm import XArmDriver, XArmDriverConfig
from LIMA.manipulation.control import CartesianMotionController, CartesianMotionControllerConfig
...
from LIMA.core.transport import pSHMTransport
...
python -m LIMA.manipulation.control.target_setter
```
...
Copyright 2025 LIMA Robotics Inc. - Apache 2.0 License
