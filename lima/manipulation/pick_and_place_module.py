...
from lima.constants import LIMA_PROJECT_ROOT
from lima.core.core import rpc
from lima.core.docker_runner import DockerModule as DockerRunner
from lima.core.stream import In  # noqa: TC001
from lima.manipulation.grasping.graspgen_module import GraspGenModule
from lima.manipulation.manipulation_module import (
    ManipulationModule,
    ManipulationModuleConfig,
)
from lima.msgs.geometry_msgs import Pose, Quaternion, Vector3
from lima.perception.detection.type.detection3d.object import (
...
if TYPE_CHECKING:
    from lima.msgs.geometry_msgs import PoseArray
...
class PickAndPlaceModuleConfig(ManipulationModuleConfig):
    ...
    graspgen_docker_image: str = "lima-graspgen:latest"
    ...
    graspgen_visualization_output_path: Path = field(
        default_factory=lambda: Path.home() / ".lima" / "graspgen" / "visualization.json"
    )
...
class PickAndPlaceModule(ManipulationModule):
    ...
    def _get_graspgen(self) -> DockerRunner:
        ...
        with self._lock:
            ...
            graspgen = DockerRunner(
                ...
                docker_build_context=LIMA_PROJECT_ROOT,
    ...
    def _compute_pre_grasp_pose(self, grasp_pose: Pose, offset: float = 0.10) -> Pose:
        ...
        """
        from lima.utils.transform_utils import offset_distance
