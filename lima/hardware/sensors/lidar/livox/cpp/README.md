...
```bash
cd LIMA/hardware/sensors/lidar/livox/cpp
...
CMake automatically fetches [LIMA-lcm](https://github.com/LIMA Robotics/LIMA-lcm)
...
| `LIMA_native_module.hpp` | Reusable header for parsing NativeModule CLI args        |
| `flake.nix`               | Nix flake for hermetic builds                            |
| `CMakeLists.txt`          | Build config, fetches LIMA-lcm headers automatically    |
