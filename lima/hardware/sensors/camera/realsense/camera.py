...
from lima.hardware.sensors.camera.spec import (
    OPTICAL_ROTATION,
    DepthCameraConfig,
    DepthCameraHardware,
)
from lima.msgs.geometry_msgs import Quaternion, Transform, Vector3
from lima.msgs.sensor_msgs import CameraInfo
...
def main() -> None:
    ...
    camera = lima.deploy(RealSenseCamera, enable_pointcloud=True, pointcloud_fps=5.0)  # type: ignore[type-var]
