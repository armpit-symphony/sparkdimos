...
from lima.hardware.sensors.camera.gstreamer.gstreamer_camera import GstreamerCameraModule
from lima.msgs.sensor_msgs import Image
from lima.protocol import pubsub
...
def main() -> None:
    ...
    camera = lima.deploy(  # type: ignore[attr-defined]
    ...
    logger.info(
        f"  python3 lima/hardware/gstreamer_sender.py --device /dev/video0 --host 0.0.0.0 --port {args.port}"
    )
