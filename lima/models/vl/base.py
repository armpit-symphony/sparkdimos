...
from lima.utils.decorators import retry
from lima.utils.llm_utils import extract_json

if TYPE_CHECKING:
    from lima.perception.detection.type import Detection2DBBox, Detection2DPoint, ImageDetections2D
...
def vlm_detection_to_detection2d(
    ...
    from lima.perception.detection.type import Detection2DBBox
...
def vlm_point_to_detection2d_point(
    ...
    """
    from lima.perception.detection.type import Detection2DPoint
...
class VlModel(Captioner, Resource, Configurable[VlModelConfig]):
    ...
    def query_detections(
        ...
        # Here to prevent unwanted imports in the file.
        from lima.perception.detection.type import ImageDetections2D
