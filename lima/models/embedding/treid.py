...
from lima.models.base import LocalModel
from lima.models.embedding.base import Embedding, EmbeddingModel, EmbeddingModelConfig
...
# into lima/data/models_torchreid/
