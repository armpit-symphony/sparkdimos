...
try:
    ...
    from lima_lcm.geometry_msgs import (  # type: ignore[no-redef]
        Point,
        Pose,
        Quaternion,
        Twist,
    )
    from lima_lcm.nav_msgs import OccupancyGrid, Odometry  # type: ignore[no-redef]
    from lima_lcm.std_msgs import Header  # type: ignore[no-redef]
