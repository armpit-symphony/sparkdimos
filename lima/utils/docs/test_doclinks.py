...
class TestFileIndex:
    def test_finds_spec_files(self, file_index):
        ...
        assert candidates[0] == Path("lima/protocol/service/spec.py")
...
class TestSymbolLookup:
    def test_find_configurable_in_spec(self):
        ...
        spec_path = REPO_ROOT / "lima/protocol/service/spec.py"
...
class TestProcessMarkdown:
    def test_resolves_service_spec(self, file_index):
        ...
        assert "/lima/protocol/service/spec.py" in new_content
    ...
    def test_github_mode(self, file_index):
        ...
        assert "https://github.com/org/repo/blob/main/lima/protocol/service/spec.py" in new_content
...
class TestIgnoreRegions:
    ...
    def test_ignores_links_in_region(self, file_index):
        ...
        assert "/lima/protocol/service/spec.py" in lines[0]
        assert "/lima/protocol/service/spec.py" in lines[-1]
...
class TestLinkResolution:
    ...
    def test_validates_absolute_py_link(self, file_index, doc_index):
        ...
        content = "[spec](/lima/protocol/service/spec.py)"
        new_content, changes, errors = self._process(content, file_index, doc_index)
