...
Usage:
    uv run python -m lima.utils.cli.dtop [--topic /lima/resource_stats]
"""
...
from lima.utils.cli import theme
...
class ResourceSpyApp(App[None]):
    ...
    def __init__(self, topic_name: str = "/lima/resource_stats") -> None:
        super().__init__()
