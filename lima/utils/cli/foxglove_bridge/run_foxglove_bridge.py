...
"""
use lcm_foxglove_bridge as a module from lima_lcm
"""
...
import lima_lcm
from lima_lcm.foxglove_bridge import FoxgloveBridge

lima_lcm_path = os.path.dirname(os.path.abspath(lima_lcm.__file__))
print(f"Using lima_lcm from: {lima_lcm_path}")
