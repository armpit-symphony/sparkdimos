...
def import_cli_in_background() -> None:
    ...
    try:
        from lima.utils.cli.human.humancli import main as humancli_main
...
def run_banner_animation() -> None:
    ...
    animation_style = os.environ.get("LIMA_BANNER_ANIMATION", random.choice(random_anim)).lower()
