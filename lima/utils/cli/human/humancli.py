...
from lima.utils.generic import truncate_display_string
...
class HumanCLIApp(App):  # type: ignore[type-arg]
    """IRC-like interface for interacting with LIMA agents."""
    ...
    def on_mount(self) -> None:
        ...
        self._add_system_message("Connected to LIMA Agent Interface")
