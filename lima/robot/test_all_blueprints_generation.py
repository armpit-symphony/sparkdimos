...
IGNORED_FILES: set[str] = {
    "lima/robot/all_blueprints.py",
    "lima/robot/get_all_blueprints.py",
    "lima/robot/test_all_blueprints.py",
    "lima/robot/test_all_blueprints_generation.py",
    "lima/core/blueprints.py",
    "lima/core/test_blueprints.py",
}
BLUEPRINT_METHODS = {"transports", "global_config", "remappings", "requirements", "configurators"}


def test_all_blueprints_is_current() -> None:
    root = LIMA_PROJECT_ROOT / "lima"
    ...
    if "CI" in os.environ:
        ...
        if current_content != generated_content:
            ...
            pytest.fail(
                ...
                f"`pytest lima/robot/test_all_blueprints_generation.py` locally to update.\n\n"
                f"Diff:\n{diff_str}"
            )
    else:
