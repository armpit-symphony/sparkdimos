...
"""LIMA module wrapper for drone connection."""
...
from lima_lcm.std_msgs import String
...
from lima.robot.drone.dji_video_stream import DJIDroneVideoStream
from lima.robot.drone.mavlink_connection import MavlinkConnection
...
class DroneConnectionModule(Module):
    ...
    def start(self) -> None:
        ...
        if self.connection_string == "replay":
            ...
            from lima.robot.drone.mavlink_connection import FakeMavlinkConnection
        ...
        if self.video_stream.start():
            ...
            # from lima.utils.testing import TimedSensorStorage
