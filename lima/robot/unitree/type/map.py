...
from lima.mapping.pointclouds.accumulators.general import GeneralPointCloudAccumulator
from lima.mapping.pointclouds.accumulators.protocol import PointCloudAccumulator
from lima.mapping.pointclouds.occupancy import general_occupancy
from lima.msgs.nav_msgs import OccupancyGrid
from lima.msgs.sensor_msgs import PointCloud2
from lima.robot.unitree.go2.connection import Go2ConnectionProtocol
...
def deploy(lima: ModuleCoordinator, connection: Go2ConnectionProtocol):  # type: ignore[no-untyped-def]
    mapper = lima.deploy(Map, global_publish_interval=1.0)  # type: ignore[attr-defined]
