...
Teleoperation modules for LIMA. Supports Meta Quest 3 VR controllers and phone motion sensors.
...
```bash
LIMA run arm-teleop            # Quest arm teleop
LIMA run phone-go2-teleop      # Phone → Go2
```
