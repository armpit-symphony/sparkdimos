...
Wraps a pygame UI as a LIMA Module so it can be composed with coordinator
...
from lima.control.examples.cartesian_ik_jogger import JogState
...
class KeyboardTeleopModule(Module[KeyboardTeleopConfig]):
    """Pygame-based cartesian keyboard teleop as a LIMA Module.
