...
from lima.stream.audio.base import (
    AbstractAudioConsumer,
    AudioEvent,
)
from lima.stream.audio.text.base import AbstractTextEmitter
...
if __name__ == "__main__":
    from lima.stream.audio.node_key_recorder import KeyRecorder
    from lima.stream.audio.node_microphone import (
        SounddeviceAudioSource,
    )
    from lima.stream.audio.node_normalizer import AudioNormalizer
    from lima.stream.audio.node_output import SounddeviceAudioOutput
    from lima.stream.audio.node_volume_monitor import monitor
    from lima.stream.audio.text.node_stdout import TextPrinterNode
    from lima.stream.audio.tts.node_openai import OpenAITTSNode
    from lima.stream.audio.utils import keepalive
