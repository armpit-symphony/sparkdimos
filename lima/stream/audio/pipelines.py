...
from lima.stream.audio.node_microphone import SounddeviceAudioSource
...
from lima.stream.audio.stt.node_whisper import WhisperNode
from lima.stream.audio.text.node_stdout import TextPrinterNode
from lima.stream.audio.tts.node_openai import OpenAITTSNode, Voice
