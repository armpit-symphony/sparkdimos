...
from lima_lcm.vision_msgs import (
    BoundingBox2D,
...
from lima.perception.detection.type.detection2d.base import Detection2D
from lima.types.timestamped import to_ros_stamp, to_timestamp
