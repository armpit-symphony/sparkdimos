...
from lima_lcm.foxglove_msgs.ImageAnnotations import ImageAnnotations
from lima_lcm.foxglove_msgs.SceneUpdate import SceneUpdate
from lima_lcm.visualization_msgs.MarkerArray import MarkerArray
import pytest
...
from lima.perception.detection.module2D import Detection2DModule
from lima.perception.detection.module3D import Detection3DModule
from lima.perception.detection.moduleDB import ObjectDBModule
from lima.perception.detection.type import (
    Detection2D,
    Detection3DPC,
    ImageDetections2D,
    ImageDetections3DPC,
...
from lima.robot.unitree.go2 import connection
...
def get_moment_2d(get_moment) -> Generator[Callable[[], Moment2D], None, None]:
    from lima.perception.detection.detectors import Yolo2DDetector
