...
from lima.perception.detection.type.detection2d.imageDetections2D import ImageDetections2D
from lima.perception.detection.type.detection3d import Detection3DPC
from lima.perception.detection.type.detection3d.imageDetections3DPC import ImageDetections3DPC
...
def deploy(  # type: ignore[no-untyped-def]
    ...
    **kwargs,
    ...
    detector = lima.deploy(Detection3DModule, camera_info=camera.hardware_camera_info, **kwargs)  # type: ignore[attr-defined]
