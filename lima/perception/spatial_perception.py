...
from lima.agents_deprecated.memory.image_embedding import ImageEmbeddingProvider
from lima.agents_deprecated.memory.spatial_vector_db import SpatialVectorDB
from lima.agents_deprecated.memory.visual_memory import VisualMemory
...
from lima.types.robot_location import RobotLocation
from lima.utils.logging_config import setup_logger

if TYPE_CHECKING:
    from lima.msgs.geometry_msgs import Vector3

_OUTPUT_DIR = LIMA_PROJECT_ROOT / "assets" / "output"
...
class SpatialMemory(Module):
    """
    A LIMA Robotics module for building and querying Robot spatial memory.
...
def deploy(  # type: ignore[no-untyped-def]
    ...
    spatial_memory = lima.deploy(SpatialMemory, db_path="/tmp/spatial_memory_db")  # type: ignore[attr-defined]
