...
from lima.msgs.geometry_msgs import PoseStamped, Quaternion, VectorLike
from lima.msgs.nav_msgs import CostValues, OccupancyGrid, Path
from lima.utils.logging_config import setup_logger

# Try to import C++ extension for faster pathfinding
try:
    from lima.navigation.replanning_a_star.min_cost_astar_ext import (
