...
from lima_lcm.sensor_msgs import CameraInfo as LimaLcmCameraInfo
import numpy as np

from lima.msgs.geometry_msgs import Transform, Twist, Vector3
...
from lima.protocol.tf import LCMTF
...
class DetectionNavigation:
    ...
    def compute_twist_for_detection_3d(
        ...
        lcm_camera_info = LimaLcmCameraInfo()
