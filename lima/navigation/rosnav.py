...
from lima.msgs.nav_msgs import Path
from lima.msgs.sensor_msgs import Joy, PointCloud2
from lima.msgs.std_msgs import Bool, Int8
from lima.msgs.tf2_msgs.TFMessage import TFMessage
from lima.navigation.base import NavigationInterface, NavigationState
from lima.utils.logging_config import setup_logger
from lima.utils.transform_utils import euler_to_quaternion
...
def deploy(lima: ModuleCoordinator):  # type: ignore[no-untyped-def]
    nav = lima.deploy(ROSNav)  # type: ignore[attr-defined]
